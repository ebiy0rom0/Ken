...
export const Config = {
  ...
  LISTEN_ONLY_CHANNEL_ID: ken.transformers.snowflake(
    Deno.env.get("LISTEN_ONLY_CHANNEL_ID")!,
  ),
  BOT_INFO_CHANNEL_ID: ken.transformers.snowflake(Deno.env.get("BOT_INFO_CHANNEL_ID")!),
  NG_COLLECT_CHANNEL_ID: ken.transformers.snowflake(
    Deno.env.get("NG_COLLECT_CHANNEL_ID")!,
  ),
